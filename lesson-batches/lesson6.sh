...
category="game"
set_split="train"
words=("airplane" "balloon" "bed" "bedroom" "boat" "book" "car" "closet" "drawer" "glasswindow" "jacket" "jeans" "lamp" "napkin" "pajamas" "pen" "pencil" "penny" "potty" "radio" "refrigerator" "scissors" "shirt" "shoe" "shower" "toothbrush" "tv" "vacuum" "table" "zipper" "dryer" "hat" "mitten" "pool" "room" "helicopter" "underwear")
